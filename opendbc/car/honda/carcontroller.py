...
from opendbc.car.honda.values import CruiseButtons, VISUAL_HUD, HONDA_BOSCH, HONDA_BOSCH_CANFD, HONDA_BOSCH_RADARLESS, HONDA_NIDEC_ALT_PCM_ACCEL, CarControllerParams
...
class CarController(CarControllerBase, MadsCarController):
  ...
  def update(self, CC, CC_SP, CS, now_nanos):
    ...
    if not self.CP.openpilotLongitudinalControl:
      if self.frame % 2 == 0 and self.CP.carFingerprint not in (HONDA_BOSCH_RADARLESS|HONDA_BOSCH_CANFD):  # radarless cars don't have supplemental message
